...
export function AddProductTypeForm({
  ...
  const toggleButton = (
    <Button 
      onClick={onToggleAddProductForm}
      variant={showAddProductForm ? "default" : "outline"}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => onSelectedProductTypeIdChange(e.target.value)}
              >
            ...
            <div className="space-y-2">
              ...
              <Input
                id="baseCode"
                value={baseCode}
                onChange={(e) => onBaseCodeChange(e.target.value.toUpperCase())}
              ...
              <div key={index} className="grid grid-cols-1 md:grid-cols-5 gap-3 items-end">
                ...
                <div className="md:col-span-1">
                  ...
                  <select
                    ...
                    onChange={(e) => onRetailerChange(index, e.target.value as RetailerCode)}
                  >
