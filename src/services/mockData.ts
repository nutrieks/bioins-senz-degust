    ...
    jarAttributes: [
      {
        ...
        nameHR: "Slanost",
        nameEN: "Saltiness",
        scaleHR: ["Premalo slano", "Malo slano", "Baš kako treba", "Dosta slano", "Previše slano"],
        scaleEN: ["Not salty enough", "Slightly not salty enough", "Just About Right", "Slightly too salty", "Too salty"]
      },
      {
        id: "attr_base_1_2",
        productTypeId: "base_product_1",
        nameHR: "Tvrdoća",
        nameEN: "Hardness",
        scaleHR: ["Premekano", "Malo mekano", "Baš kako treba", "Malo tvrdo", "Pretvrdo"],
        scaleEN: ["Too soft", "Slightly too soft", "Just About Right", "Slightly too hard", "Too hard"]
      },
      {
        id: "attr_base_1_3",
        productTypeId: "base_product_1",
        nameHR: "Sočnost",
        nameEN: "Juiciness",
        scaleHR: ["Nedovoljno sočno", "Malo premalo sočno", "Baš kako treba", "Malo previše sočno", "Previše sočno"],
        scaleEN: ["Not juicy enough", "Slightly not juicy enough", "Just About Right", "Slightly too juicy", "Too juicy"]
      },
      {
        id: "attr_base_1_4",
        productTypeId: "base_product_1",
        nameHR: "Začinjenost",
        nameEN: "Spiciness",
        scaleHR: ["Premalo začinjeno", "Malo premalo začinjeno", "Baš kako treba", "Malo previše začinjeno", "Previše začinjeno"],
        scaleEN: ["Not spicy enough", "Slightly not spicy enough", "Just About Right", "Slightly too spicy", "Too spicy"]
      }
    ],
  ...
  },
  {
    ...
    jarAttributes: [
      ...
      },
      {
        ...
        nameHR: "Kiselost",
        nameEN: "Sourness",
        scaleHR: ["Nedovoljno kiselo", "Malo premalo kiselo", "Baš kako treba", "Malo previše kiselo", "Previše kiselo"],
        scaleEN: ["Not sour enough", "Slightly not sour enough", "Just About Right", "Slightly too sour", "Too sour"]
      },
      {
        id: "attr_base_2_3",
        productTypeId: "base_product_2",
        nameHR: "Kremastost",
        nameEN: "Creaminess",
        scaleHR: ["Nedovoljno kremasto", "Malo premalo kremasto", "Baš kako treba", "Malo previše kremasto", "Previše kremasto"],
        scaleEN: ["Not creamy enough", "Slightly not creamy enough", "Just About Right", "Slightly too creamy", "Too creamy"]
      },
      {
        id: "attr_base_2_4",
        productTypeId: "base_product_2",
        ...
        scaleHR: ["Preslaba aroma", "Malo preslaba aroma", "Baš kako treba", "Malo prejaka aroma", "Prejaka aroma"],
        scaleEN: ["Too weak flavor", "Slightly too weak flavor", "Just About Right", "Slightly too strong flavor", "Too strong flavor"]
      }
    ],
